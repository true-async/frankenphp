...
- убедитесь, что [OPcache](https://www.php.net/manual/book.opcache.php) установлен, включён и настроен должным образом;
...
- используйте [предварительную загрузку](https://www.php.net/manual/opcache.preloading.php).
